...
export default function Home() {
  ...
  const [showTargetCurrency, setShowTargetCurrency] = useState(true); // Add this line
    ...
    <main className="p-8">
      <div id="printable-wrapper" className="grid grid-cols-2 gap-8 items-start">
        <div className="col-span-1 bg-white p-8 rounded-lg shadow-md">
          ...
          <InvoiceForm setInvoiceData={setInvoiceData} setFocusedField={setFocusedField} showTargetCurrency={showTargetCurrency} setShowTargetCurrency={setShowTargetCurrency} />
        </div>
        <div className="col-span-1 bg-white p-8 rounded-lg shadow-md">
